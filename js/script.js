...
import {contentGH} from "./fetchGH_API.js";
...
$(document).ready(function () {
    ...
    //     let posX =
    //         (0.65 * document.querySelector("body").clientWidth) / 2 - 200;
    ...
    //                 200 -
    //                 4 *
    //                     (0.65 * document.querySelector("body").clientWidth +
    //                         400)
    //         ) {
    ...
    $("nav a[id='lien4']").click(function () {
        $("main>*").animate({ opacity: 0 }, 300, () => {
            $("main>*").hide();
            $(".contact").show().animate({ opacity: 1 }, 800);
        });
    });

    $(".navMob a[id='lien4']").click(function () {
        $("main>*").animate({ opacity: 0 }, 300, () => {
            $("main>*").hide();
            $(".contact").show().animate({ opacity: 1 }, 800);
        });
    ...
    $("nav a[id='lien5']").click(function () {
        $("main>*").animate({ opacity: 0 }, 300, () => {
            $("main>*").hide();
            $(".github").show().animate({ opacity: 1 }, 800);
        });
    });

    $(".navMob a[id='lien5']").click(function () {
        $("main>*").animate({ opacity: 0 }, 300, () => {
            $("main>*").hide();
            $(".github").show().animate({ opacity: 1 }, 800);
        });
    ...
    $("nav a[id='lien6']").click(function () {
        $("main>*").animate({ opacity: 0 }, 300, () => {
            $("main>*").hide();
            $(".jeux").show().animate({ opacity: 1 }, 800);
        });
    });

    $(".navMob a[id='lien6']").click(function () {
        $("main>*").animate({ opacity: 0 }, 300, () => {
            $("main>*").hide();
            $(".jeux").show().animate({ opacity: 1 }, 800);
        });
...
contentGH().then((content)=>  {

    document.getElementById("contentGH").innerHTML = content;
})
